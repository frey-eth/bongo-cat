...
const ClaimAirdrop = () => {
  return (
    <div className="p-2">
      <div className="w-full md:max-w-[800px] border-2 border-blue-600 rounded-lg p-8 bg-[#1a1d2c] md:-mt-[100px] -mt-[200px] flex flex-col gap-4 ">
        <div className="text-center  flex gap-4 flex-col font-crotah">
          ...
          <p className="text-white font-light max-md:text-[14px]">
            ...
            by those who have claimed the ZKSync airdrop. $BONGO tokens that
            have not been claimed within 31 days will be used for the Community
            Long-Term Incentive Reward Program. The $BONGO will be distributed
            to the top contributors of ZKsync community and burned.
          </p>
        </div>
